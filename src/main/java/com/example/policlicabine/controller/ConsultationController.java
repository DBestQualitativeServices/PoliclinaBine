...
/**
 * REST Controller for Consultation Management Operations.
 *
...
public class ConsultationController {
    ...
    public ResponseEntity<?> createConsultation(
        ...
        Result<ConsultationDto> result = consultationService.createConsultation(
    ...
    public ResponseEntity<List<ConsultationDto>> getAllConsultations() {
        ...
        Result<List<ConsultationDto>> result = consultationService.findAll();
    ...
    public ResponseEntity<?> updateConsultation(
        ...
        Result<ConsultationDto> result = consultationService.update(consultationId, consultationDto);
    ...
    public ResponseEntity<?> updatePrice(
        ...
        Result<ConsultationDto> result = consultationService.updatePrice(consultationId, price);
    ...
    @ApiResponse(responseCode = "200", description = "Consultation deactivated successfully")
    ...
    @ApiResponse(responseCode = "200", description = "Consultation activated successfully")
